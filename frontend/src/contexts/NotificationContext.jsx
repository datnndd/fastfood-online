...
export function NotificationProvider({ children }) {
    ...
    // Note: We only refresh unread count here since the CartPage already added
    // a local notification for immediate feedback
    useEffect(() => {
        if (!user) return

        const handleOrderPlaced = () => {
            // Only refresh unread count, not the full notification list
            // The local notification from pushLocalNotification provides immediate feedback
            fetchUnreadCount()
        }
